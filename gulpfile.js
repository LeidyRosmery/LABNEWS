...
gulp.task('js', () => {
    gulp.src(["./src/assets/js/components/principal.js","./src/assets/js/components/mundo.js", "./src/assets/js/components/header.js", "./src/assets/js/utils/get-json.js", "./src/assets/js/index.js"])
